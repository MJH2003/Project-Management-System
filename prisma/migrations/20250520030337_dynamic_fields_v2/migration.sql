...
*/
-- CreateEnum
CREATE TYPE "OptionSource" AS ENUM ('STATIC', 'PROJECT_MEMBERS', 'PROJECT_TASKS', 'USER_PROJECTS');
...
ADD COLUMN     "optionSource" "OptionSource" NOT NULL DEFAULT 'STATIC',
...
-- DropEnum
DROP TYPE "DynamicDataSourceType";
